...
import edu.hut.transformer.service.impl.DimensionConverterImpl;
import edu.hut.util.JdbcManager;
...
public class TransformerOutputFormat extends
		OutputFormat<BaseDimension, BaseStatsValueWritable> {
	private static final Logger logger = Logger
			.getLogger(TransformerOutputFormat.class);
	 ...
	 *
	 */
	public class TransformerRecordWriter extends
		...
		private Map<KpiEnum, Integer> batch = new HashMap<KpiEnum, Integer>();
