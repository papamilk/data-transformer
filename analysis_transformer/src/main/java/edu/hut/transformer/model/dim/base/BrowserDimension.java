...
public class BrowserDimension extends BaseDimension {
	...
	public static BrowserDimension newInstance(String browserName,
			String browserVersion) {
		BrowserDimension dim = new BrowserDimension(browserName, browserVersion);
		return dim;
	}
	 ...
	 * @return
	 */
	public static List<BrowserDimension> list(String browserName,
			String browserVersion) {
		List<BrowserDimension> list = new ArrayList<BrowserDimension>();
		if (StringUtils.isBlank(browserName)) {
			// 如果浏览器名称为空，那么设置为unknown
		...
		list.add(BrowserDimension.newInstance(browserName,
